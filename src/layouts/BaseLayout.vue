    ...
    <SidebarInset class="overflow-hidden">
      <header
        ...
        <ScrollArea class="group flex-1 whitespace-nowrap">
          ...
          <ScrollBar class="opacity-0 group-hover:opacity-100 transition-opacity" orientation="horizontal" forceMount />
        </ScrollArea>
        <div class="absolute top-0 bottom-0 right-0 w-6 bg-gradient-to-r from-background/10 to-background"></div>
      </header>
